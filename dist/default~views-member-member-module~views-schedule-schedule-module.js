(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-member-member-module~views-schedule-schedule-module"],{
...
/***/ "./src/app/shared/services/classRegisterService.service.ts":
/*!*****************************************************************!*\
  !*** ./src/app/shared/services/classRegisterService.service.ts ***!
  \*****************************************************************/
/*! exports provided: ClassRegisterService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClassRegisterService", function() { return ClassRegisterService; });
...
var ClassRegisterService = /** @class */ (function () {
    // readonly apiURL = "http://localhost/efc/api";
    function ClassRegisterService(http, store) {
        this.http = http;
        this.store = store;
        this.apiURL = "https://api.empirefit.club/api";
        this.localURL = "http://localhost/efc/api";
        this.httpOptions = {
    ...
    ClassRegisterService.prototype.getClassRegistrations = function () {
        return this.http.get(this.apiURL + "/class_registrations", this.httpOptions);
    };
    ClassRegisterService.prototype.registerClass = function (data) {
        return this.http.post(this.apiURL + "/class_registrations", data, this.httpOptions);
    };
    ClassRegisterService.prototype.searchClass = function (data) {
        return this.http.post(this.apiURL + "/search_class_registration", data, this.httpOptions);
    };
    ClassRegisterService.prototype.search = function (data) {
        return this.http.post(this.apiURL + "/search_class", data, this.httpOptions);
    };
    ClassRegisterService.prototype.viewClass = function (data) {
        return this.http.post(this.apiURL + "/view_class", data, this.httpOptions);
    };
    ClassRegisterService.prototype.download = function (data) {
        return this.http.post(this.apiURL + "/download_class", data, this.httpOptions);
    };
    ClassRegisterService = __decorate([
...
//# sourceMappingURL=default~views-member-member-module~views-schedule-schedule-module.js.map