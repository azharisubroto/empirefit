(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~views-finance-finance-module~views-master-master-module~views-member-member-module~views-mem~0f237062"],{
...
var BranchService = /** @class */ (function () {
    ...
    function BranchService(http, store) {
        this.http = http;
        this.store = store;
    ...
    BranchService.prototype.createBranch = function (data) {
    ...
    BranchService.prototype.showBranch = function (id) {
        return this.http.get(this.apiURL + "/branches/" + id, this.httpOptions);
    };
    BranchService.prototype.updateBranch = function (id, data) {
        return this.http.put(this.apiURL + "/branches/" + id, data, this.httpOptions);
    };
...
//# sourceMappingURL=default~views-finance-finance-module~views-master-master-module~views-member-member-module~views-mem~0f237062.js.map