...
var SigninComponent = /** @class */ (function () {
    function SigninComponent(store, fb, auth, router) {
        this.store = store;
        this.fb = fb;
        this.auth = auth;
        this.router = router;
    ...
    SigninComponent.prototype.ngOnInit = function () {
        ...
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouteConfigLoadStart"] ||
                event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["ResolveStart"]) {
    ...
    SigninComponent.prototype.signin = function () {
        ...
        if (this.signinForm.invalid) {
            ...
            this.auth.signin(this.signinForm.value).subscribe(function (data) {
                if (data.status == "200") {
                    _this.store.setItem("access_token", data.access_token);
                    _this.redirect = "";
    ...
    SigninComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_shared_services_local_store_service__WEBPACK_IMPORTED_MODULE_5__["LocalStoreService"],
