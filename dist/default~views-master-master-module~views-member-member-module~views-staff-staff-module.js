...
var ScheduleService = /** @class */ (function () {
    ...
    ScheduleService.prototype.showClassRegistration = function (id) {
        return this.http.get(this.apiURL + "/show_class_registration/" + id, this.httpOptions);
    };
    ScheduleService.prototype.getByDay = function (date) {
        return this.http.get(this.apiURL + "/schedules/day/" + date, this.httpOptions);
    };
    ScheduleService.prototype.byDay = function (date) {
