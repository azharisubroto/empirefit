...
var map = {
	"./views/finance/finance.module": [
		...
		"default~views-finance-finance-module~views-master-master-module~views-member-member-module~views-mem~0f237062",
		"default~views-finance-finance-module~views-master-master-module~views-member-member-module~views-mem~254b7408",
		"default~views-finance-finance-module~views-member-member-module~views-member-partner-member-partner-~7e245b61",
		"default~views-finance-finance-module~views-member-member-module~views-schedule-schedule-module",
		"common",
		"views-finance-finance-module"
	],
	"./views/master/master.module": [
		...
		"default~views-master-master-module~views-member-member-module~views-member-partner-member-partner-mo~93bbe2a7",
		"common",
		"views-master-master-module"
	],
	"./views/member-partner/member-partner.module": [
		...
		"default~views-finance-finance-module~views-member-member-module~views-member-partner-member-partner-~7e245b61",
		"default~views-master-master-module~views-member-member-module~views-member-partner-member-partner-mo~93bbe2a7",
		"default~views-member-member-module~views-member-partner-member-partner-module",
		"common",
		"views-member-partner-member-partner-module"
	],
	"./views/member/member.module": [
		...
		"default~views-master-master-module~views-member-member-module~views-staff-staff-module",
		"default~views-master-master-module~views-member-member-module~views-member-partner-member-partner-mo~93bbe2a7",
		"default~views-member-member-module~views-schedule-schedule-module",
		"default~views-member-member-module~views-member-partner-member-partner-module",
		"common",
		"views-member-member-module"
	],
	...
	"./views/reset-password/reset-password.module": [
...
/* harmony import */ var _shared_services_auth_permission__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shared/services/auth.permission */ "./src/app/shared/services/auth.permission.ts");
...
var dashboard = [
    {
        path: "dashboard",
        canActivate: [_shared_services_auth_permission__WEBPACK_IMPORTED_MODULE_4__["AuthPermission"]],
        data: {
...
var routes = [
    ...
    {
        path: "",
        component: _shared_components_layouts_admin_layout_sidebar_large_admin_layout_sidebar_large_component__WEBPACK_IMPORTED_MODULE_6__["AdminLayoutSidebarLargeComponent"],
        children: [
            {
                path: "reset-password",
...
module.exports = "button {\n  position: relative;\n  transition: all .15s ease-in-out; }\n  button.loading {\n    padding-left: 36px; }\n  button .btn-spinner {\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    margin: auto;\n    left: 10px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _services_permission_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../services/permission.service */ "./src/app/shared/services/permission.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SidebarLargeComponent = /** @class */ (function () {
    function SidebarLargeComponent(router, navService, authService, permissionService) {
        this.router = router;
        this.navService = navService;
        this.authService = authService;
    ...
    SidebarLargeComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getUser().subscribe(function (data) {
            _this.user = data["data"];
            _this.role_id = _this.user.role_user["0"].id;
            _this.permissionService.permission_role(_this.role_id).subscribe(function (data) {
                _this.permissions = data["data"];
                _this.navService.menuItems$
                    .subscribe(function (items) {
                    _this.menu = items;
                });
                _this.permissions.forEach(function (data) {
                    _this.menu.forEach(function (item) {
                        if (item.perm == 7) {
                            item.sub.forEach(function (res) {
                                if (data.permission_id == res.perm) {
                                    _this.newSubmenu.push(res);
                                }
                            });
                            if (data.permission_id == item.perm) {
                                _this.newMenu.push(item);
                            }
                        }
                        else {
                            if (data.permission_id == item.perm) {
    ...
    SidebarLargeComponent.prototype.hasmatch = function (array, key, value) {
    ...
    SidebarLargeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _services_permission_service__WEBPACK_IMPORTED_MODULE_6__["PermissionService"]])
...
module.exports = "<div class=\"auth-layout-wrap\" style=\"background-image: url(./assets/images/background-efc2.jpg)\">\n    <div class=\"auth-content\">\n        <router-outlet></router-outlet>\n    </div>\n</div>"
...
/***/ "./src/app/shared/services/auth.permission.ts":
/*!****************************************************!*\
  !*** ./src/app/shared/services/auth.permission.ts ***!
  \****************************************************/
/*! exports provided: AuthPermission */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthPermission", function() { return AuthPermission; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth.service */ "./src/app/shared/services/auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var AuthPermission = /** @class */ (function () {
    function AuthPermission(router, auth) {
        this.router = router;
        this.auth = auth;
    }
    AuthPermission.prototype.canActivate = function (route) {
        var _this = this;
        var expectedPermission = route.data.expectedPermission;
        this.auth.checkPermission(expectedPermission).subscribe(function (data) {
            if (_this.auth.authenticated) {
                if (data["status"] == "200") {
                    return true;
                }
                else {
                    return _this.router.navigateByUrl('others/404');
                }
            }
            else {
                return _this.router.navigateByUrl('/sessions/signin');
            }
        });
        return true;
    };
    AuthPermission = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: "root"
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
...
/* harmony import */ var _permission_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./permission.service */ "./src/app/shared/services/permission.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthService = /** @class */ (function () {
    ...
    function AuthService(store, router, http, permissionService) {
        this.store = store;
        this.router = router;
        this.http = http;
        this.permissionService = permissionService;
    ...
    AuthService.prototype.checkPermission = function (permission_id) {
    ...
    AuthService = __decorate([
        ...
        __metadata("design:paramtypes", [_local_store_service__WEBPACK_IMPORTED_MODULE_1__["LocalStoreService"],
            ...
            _permission_service__WEBPACK_IMPORTED_MODULE_5__["PermissionService"]])
    ], AuthService);
    return AuthService;
}());
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/empire-fit-club/efc/src/main.ts */"./src/main.ts");
